...
## Never commit
1.  Passwords, API keys, tokens, or other credentials — even temporarily, even "just for testing"
2.  Personal data of other people (names, emails, photos with faces) — including your classmates
3.  Real-world targets (IP addresses, hostnames, employee info) from environments you don't own
4.  Screenshots that contain credentials, session tokens, or personal information
5.  Anything from the OSINT investigations on the fictional persona that could be used to identify a real person
